...
sounds["jumpHero"] = audio.loadSound( "sound/hero_jump.wav" )
sounds["door"] = audio.loadSound( "sound/door.wav" )
sounds["crate"] = audio.loadSound( "sound/crate.wav" )
sounds["arnie_tot"] = audio.loadSound( "sound/arnie_tot.wav" )
sounds["gameOver"] = audio.loadSound( "sound/game_over.wav" )
